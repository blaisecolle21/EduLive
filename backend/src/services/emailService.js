...
class EmailService {
  ...
  async envoyerCodeVerification(email, code) {
    ...
    if (result.success) console.log("Code OTP envoyé:", result.messageId);
    else console.error("❌ Échec envoi code OTP:", result.error);
    return result.success;
  }
  /**
   * Template HTML pour la réinitialisation de mot de passe
   */
  genererTemplateReinitialisation(resetUrl) {
    return `
    <!DOCTYPE html>
    <html lang="fr">
    <head>
          ...
          <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
              ...
              <tr>
                <td style="padding: 30px;">
                  ...
                  <p style="color: #374151; font-size: 16px; line-height: 1.6;">
                    Vous avez demandé la réinitialisation de votre mot de passe pour votre compte sur la plateforme <strong>EduLive-Cahier de Texte Online</strong>.
                  </p>
                  
                  <div style="text-align: center; margin: 30px 0;">
                    <a href="${resetUrl}" 
                       style="display: inline-block; background-color: #3b82f6; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 6px; font-weight: bold; font-size: 16px; box-shadow: 0 2px 4px rgba(59,130,246,0.3);">
                      Réinitialiser mon mot de passe
                    </a>
                  </div>

                  <p style="color: #6b7280; font-size: 14px; line-height: 1.5;">
                    Ce lien est valable pendant <strong>1 heure</strong>. Si vous n'êtes pas à l'origine de cette demande, vous pouvez ignorer cet e-mail en toute sécurité.
                  </p>
              ...
              <tr>
                <td style="background-color: #f9fafb; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb;">
                  <p style="color: #6b7280; font-size: 13px; margin: 0;">
                   EduLive: Plateforme de Gestion du Cahier de Texte<br>
                    ${new Date().getFullYear()} - Tous droits réservés
                  </p>
                </td>
              </tr>
